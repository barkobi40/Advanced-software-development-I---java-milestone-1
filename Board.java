...
public class Board {
    ...
    public Board() {
        ...
        this.color[7][7] = "Green";
        this.color[0][0] = "Orange";
        this.color[7][0] = "Orange";
        this.color[14][0] = "Orange";
        this.color[7][0] = "Orange";
        this.color[14][7] = "Orange";
        this.color[14][0] = "Orange";
        this.color[14][14] = "Orange";
        this.color[1][1] = "Green";
        this.color[2][2] = "Green";
        this.color[3][3] = "Green";
        this.color[4][4] = "Green";
        this.color[13][1] = "Green";
        this.color[12][2] = "Green";
        this.color[11][3] = "Green";
        this.color[10][4] = "Green";
        this.color[10][10] = "Green";
        this.color[11][11] = "Green";
        this.color[12][12] = "Green";
        this.color[13][13] = "Green";
        this.color[4][10] = "Green";
        this.color[1][1] = "Green";
        this.color[3][11] = "Green";
        this.color[2][12] = "Green";
        this.color[1][13] = "Green";
        this.color[3][0] = "Purple";
        this.color[11][0] = "Purple";
        this.color[6][2] = "Purple";
        this.color[8][2] = "Purple";
        this.color[0][3] = "Purple";
        this.color[14][3] = "Purple";
        this.color[6][6] = "Purple";
        this.color[8][6] = "Purple";
        this.color[12][6] = "Purple";
        this.color[3][7] = "Purple";
        this.color[11][7] = "Purple";
        this.color[2][8] = "Purple";
        this.color[6][8] = "Purple";
        this.color[8][8] = "Purple";
        this.color[12][8] = "Purple";
        this.color[0][11] = "Purple";
        this.color[14][11] = "Purple";
        this.color[6][12] = "Purple";
        this.color[3][14] = "Purple";
        this.color[11][14] = "Purple";
        this.color[7][7] = "Pink";
        this.color[5][1] = "Yellow";
        this.color[9][1] = "Yellow";
        this.color[5][1] = "Yellow";
        this.color[1][5] = "Yellow";
        this.color[5][5] = "Yellow";
        this.color[9][5] = "Yellow";
        this.color[13][5] = "Yellow";
        this.color[1][9] = "Yellow";
        this.color[5][9] = "Yellow";
        this.color[9][9] = "Yellow";
        this.color[13][9] = "Yellow";
        this.color[5][13] = "Yellow";
        this.color[9][13] = "Yellow";
    }
    ...
    int getScore(Word word) {
        ...
        if (!word.vertical) {
            int col = word.col;
            for (int i = 0; i < word.tiles.length; i++) {
                if (color[word.row][col] == "Purple")
                    score += (word.tiles[i].score * 2);
                else if (color[word.row][col] == "Yellow")
                    score += (word.tiles[i].score * 3);
                else if (color[word.row][col] == "Green" && numofwordsonboard != 1) {
                    yellow++;
                    score += word.tiles[i].score;
                } else if (color[word.row][col] == "Orange") {
                    red++;
                    score += word.tiles[i].score;
                    ;
            ...
            int row = word.row;
            for (int i = 0; i < word.tiles.length; i++) {
                if (color[row][word.col] == "Purple")
                    score += (word.tiles[i].score * 2);
                else if (color[row][word.col] == "Yellow")
                    score += (word.tiles[i].score * 3);
                else if (color[row][word.col] == "Green" && numofwordsonboard != 1) {
                    yellow++;
                    score += word.tiles[i].score;
                } else if (color[row][word.col] == "Orange") {
                    red++;
                    score += word.tiles[i].score;
                } else score += word.tiles[i].score;
                row++;
